...
namespace Calluna
{
    public interface ReadonlyObservableList<TValue> : IReadOnlyList<TValue>
    {
        ...
        /// <summary>Fired by <see cref="ObservableList{TValue}.OverrideWith"/> after all entries have been replaced in bulk. No per-item events are raised during that operation.</summary>
